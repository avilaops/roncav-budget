...
/// <summary>
/// Enumera��es e classes auxiliares para recursos brasileiros
/// </summary>
public static class RecursosBrasileiros
{
   ...
   public const string Dinheiro = "Dinheiro";
        public const string Debito = "D�bito";
 public const string Credito = "Cr�dito";
  public const string Boleto = "Boleto";
   public const string Transferencia = "Transfer�ncia";
 public const string Ted = "TED";
  ...
  public const string Telefone = "Telefone";
        public const string Aleatoria = "Chave Aleat�ria";
...
/// <summary>
/// Classe para valida��o de documentos brasileiros
/// </summary>
