...
/// <summary>
/// Representa uma categoria de transa��o
/// </summary>
[Table("Categorias")]
...
public static class CategoriasPadrao
{
    public static List<Categoria> ObterCategoriasPadrao()
    {
        ...
        {
            // Receitas
            new() { Nome = "Sal�rio", Tipo = "Receita", Icone = "??", Cor = "#4CAF50", Ordem = 1 },
 new() { Nome = "Freelance", Tipo = "Receita", Icone = "??", Cor = "#8BC34A", Ordem = 2 },
  ...
  new() { Nome = "Outras Receitas", Tipo = "Receita", Icone = "?", Cor = "#FF9800", Ordem = 5 },
            ...
            new() { Nome = "Alimenta��o", Tipo = "Despesa", Icone = "???", Cor = "#E91E63", Ordem = 11 },
   new() { Nome = "Transporte", Tipo = "Despesa", Icone = "??", Cor = "#9C27B0", Ordem = 12 },
      new() { Nome = "Sa�de", Tipo = "Despesa", Icone = "??", Cor = "#673AB7", Ordem = 13 },
  new() { Nome = "Educa��o", Tipo = "Despesa", Icone = "??", Cor = "#3F51B5", Ordem = 14 },
            
        // Despesas Vari�veis
    new() { Nome = "Lazer", Tipo = "Despesa", Icone = "??", Cor = "#2196F3", Ordem = 20 },
            new() { Nome = "Vestu�rio", Tipo = "Despesa", Icone = "??", Cor = "#03A9F4", Ordem = 21 },
new() { Nome = "Beleza", Tipo = "Despesa", Icone = "??", Cor = "#00BCD4", Ordem = 22 },
            new() { Nome = "Telefone/Internet", Tipo = "Despesa", Icone = "??", Cor = "#009688", Ordem = 23 },
            
        // Despesas Brasileiras Espec�ficas
       new() { Nome = "Impostos", Tipo = "Despesa", Icone = "??", Cor = "#795548", Ordem = 30 },
        new() { Nome = "Empr�stimos", Tipo = "Despesa", Icone = "??", Cor = "#607D8B", Ordem = 31 },
    new() { Nome = "Cart�o de Cr�dito", Tipo = "Despesa", Icone = "??", Cor = "#9E9E9E", Ordem = 32 },
