...
/// <summary>
/// Dados de exemplo para popular o app na primeira execu��o
/// </summary>
public static class DadosDeExemplo
{
 ...
 return; // J� tem dados, n�o popular
...
SaldoInicial = 10000,
 ...
 var contaCarteira = new Conta
  ...
  SaldoInicial = 200,
   ...
   var poupanca = contas.First(c => c.Nome == "Poupan�a CEF");
        var carteira = contas.First(c => c.Nome == "Carteira");

        // ===== CRIAR TRANSA��ES =====
      var categorias = await databaseService.ObterCategoriasAsync();
        var catSalario = categorias.First(c => c.Nome == "Sal�rio");
        var catAlimentacao = categorias.First(c => c.Nome == "Alimenta��o");
var catTransporte = categorias.First(c => c.Nome == "Transporte");
     var catLazer = categorias.First(c => c.Nome == "Lazer");
        ...
        var catSaude = categorias.First(c => c.Nome == "Sa�de");
    ...
    await databaseService.SalvarTransacaoAsync(new Transacao
        {
          ContaId = carteira.Id,
            ...
            Descricao = "Supermercado Atacad�o",
    Valor = 450,
      Tipo = "Despesa",
...
ContaId = inter.Id,
 ...
 Valor = 25,
  ...
  // ===== CRIAR OR�AMENTOS =====
   ...
   await databaseService.SalvarOrcamentoAsync(new OrcamentoMensal {
 CategoriaId = catAlimentacao.Id,
      Mes = mesAtual,
        Ano = anoAtual,
            ValorPlanejado = 800,
  ...
  Icone = "??",
    ...
    Nome = "Curso de Ingl�s",
      Descricao = "Investimento em educa��o",
            ValorObjetivo = 5000,
 ValorAtual = 1200,
            DataInicio = new DateTime(2025, 1, 1),
        ...
        // Atualizar gastos dos or�amentos
