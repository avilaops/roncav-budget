"""
Django settings for orcamento_web project.
"""
...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1').split(',') + ['budget.avila.inc', 'www.budget.avila.inc', '*.railway.app']
...
ROOT_URLCONF = 'orcamento_web.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'budget.context_processors.budget_notifications',
            ],
        },
    },
]

WSGI_APPLICATION = 'orcamento_web.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',
    'https://budget.avila.inc',
    'https://www.budget.avila.inc',
]
